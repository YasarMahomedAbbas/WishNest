      ...
      <Card className="max-w-lg w-full mx-4">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center space-y-2">
            <h3 className="text-xl font-semibold text-gray-900">{familyPreview.name}</h3>
            {familyPreview.description && (
              <p className="text-gray-600">{familyPreview.description}</p>
            )}
          </div>
          ...
          <div className="flex justify-between items-center py-4 border-t border-b border-gray-200">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">{familyPreview.memberCount}</div>
          ...
          {currentMembership ? (
            <div className="text-center space-y-4">
              ...
              <Badge variant={currentMembership.role === 'ADMIN' ? 'default' : 'secondary'}>
          ...
          <div className="text-center text-sm text-gray-500 border-t pt-4">
            Invite Code: <code className="font-mono bg-gray-100 px-2 py-1 rounded">{inviteCode}</code>
          </div>
        </CardContent>
      </Card>
    </div>
